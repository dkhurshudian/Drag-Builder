var HTMLSTRUCTURE = function(){
    return {
        "generalElements":{
            "tdLayout"          : "<td kh-data-usage = 'messagecolumn'></td>",
            
            "tableLayout"       : "<table kh-data-usage = 'messagetable'><tr></tr></table>",
        ...
        "dragDropElements":{
            ...
            "selectControlls" : '<div kh-data-class="block_add_del"><span kh-data-class="arrow_left"></span><div kh-data-usage="secected_controlls"><img src="/phpfoxdev/module/dance/static/css/default/default/itgotmetemplate/images/icon_remove.png" kh-data-class="deleteEl"><img src="/phpfoxdev/module/dance/static/css/default/default/itgotmetemplate/images/icon_plus.png" kh-data-class="clone"></div></div>'
        }
    }
}