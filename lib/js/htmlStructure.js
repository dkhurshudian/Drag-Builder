var HTMLSTRUCTURE = function(){
    return {
        ...
        "dragDropElements":{
            ...
            "after":"<div kh-data = 'messageElement' kh-data-element-type= '' ><div kh-data = 'messageElementContent'></div><div kh-data-usage = 'controllers'><div kh-data-usage = 'selection'></div></div></div>",
            
            "before":"<div kh-data-rel=''><div kh-data-usage='accord_block_sortable'><div kh-data-class=''><img src=''></div><span></span></div></div>"
        }
    }
}